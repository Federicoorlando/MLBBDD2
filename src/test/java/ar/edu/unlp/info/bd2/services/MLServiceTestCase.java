...
public class MLServiceTestCase {
    ...
    public void testCreateProduct() throws MLException {
    	...
    	assertEquals(40.5F,prod.getWeigth(),0.0F);
    	...
    	assertEquals(40.5F,product.getWeigth(),0.0F);
    ...
    public void testCreateDeliveryMethod() throws MLException {
    	...
    	assertEquals(250.0F,dm.getCost(),0.0F);
    	assertEquals(0.9999F,dm.getEndWeight(),0.0F);
    	...
    	assertEquals(250.0F,d.getCost(),0.0F);
    	assertEquals(0.01F,d.getStartWeight(),0.0F);
    }
    ...
    public void testCreateCreditCardPayment() throws MLException {
    	...
    	assertEquals(4052698512476369L, cc.getNumber(),0L);
    	...
    	assertEquals(4052698512476369L, c.getNumber(),0L);
    	assertEquals("Federico Orlando",c.getOwner());
    	assertEquals(exp,c.getExpiry());
    	assertEquals(452,c.getCvv(),0);
    }
    ...
    public void testOnDeliveryPayment() throws MLException {
    	...
    	assertEquals(100F,od.getPromisedAmount(),0.0F);
    	...
    	assertEquals(100F,dp.getPromisedAmount(),0.0F);
    }
    ...
    public void testCreateProductOnSale() throws MLException {
    	...
    	assertEquals(40.5F,pos.getProduct().getWeigth(),0.0F);
    	assertEquals(1,pos.getProduct().getProductsOnSale().size());
    	assertEquals(158.52F,pos.getPrice(),0.0F);
    ...
    public void testUpdateProductOnSale() throws MLException {
    	...
    	assertEquals(175F,pos2.getPrice(),0.0F);
    ...
    public void testCreatePurchase() throws MLException {
		...
		assertEquals(5, pur.getQuantity(),0);
		assertEquals(1000F, pur.getAmount(),0.0F);
